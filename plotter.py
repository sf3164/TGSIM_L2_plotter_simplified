...
def plot_selected_vehicles():
    try:
        ...
        # Load centerline
        centerline_file = os.path.join(CENTERLINE_FOLDER, f"I294_L2_Run_{run_index}-geometry-with-ramps.csv")
        ...
        fig.write_html("L2_Simplified_Plot.html")
        fig.show()
